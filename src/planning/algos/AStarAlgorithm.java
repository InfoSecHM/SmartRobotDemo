package planning.algos;



import planning.internal.DiscreteWorld;
import planning.internal.Path;
import planning.internal.PathNode;
import planning.internal.WorldNode;
...
public class AStarAlgorithm extends Algorithm {
	...
	public AStarAlgorithm(DiscreteWorld world, int heuristicType, boolean diagonalMotion) {
		...
		h = new Heuristic(world.getRows(), world.getColumns(), world.getGoal().getxLoc(), world.getGoal().getyLoc(),
				heuristicType);
