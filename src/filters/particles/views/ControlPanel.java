...
public class ControlPanel extends JPanel implements ActionListener, ChangeListener, proplistener {
	...
	public boolean loadProperties() {
		...
		try {
			...
			log.error(INVALID_TAG_VALUE + TAG_NEW_PARTICLES_RATIO);
		}
		try {
