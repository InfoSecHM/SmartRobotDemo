...
public abstract class OOMDPValue implements Value {
    ...
    public int getDiscVal() {
        throw new UnsupportedOperationException("Value is of type" + this.getClass().getSimpleName()
