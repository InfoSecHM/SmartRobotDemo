...
/**
 * This class provides a value for an integer. The value may be negative or
 * postive and exist in any range. This value object should be preferred for
 * discrete values that span a large numeric range and for which it would be
 * ineffecient to store an array of all possible values in the attribtue.
 * Otherwise the {@link DiscreteValue} class should be preferred.
 * 
