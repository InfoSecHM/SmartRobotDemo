package filters.core.values;


import java.util.Arrays;
import filters.core.Attribute;

/**
 * This class implements an attribute value that is defined with a double array.
 * In general, it is reccomended that a series of {@link RealValue} attributes
 * is defined instead of using this class, because the series of individual
 * {@link RealValue}s will have better compatibility with existing BURLAP tools
 * and algorithms, but this value can be used in cases where there is a very
 * large number of double values that have to be stored in each state to cut
 * down on memory overhead.
 * 
