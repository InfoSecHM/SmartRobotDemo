...
/**
 * A multi-target relational value object subclass. Values are stored as an
 * ordered set (TreeSet) of string names of the object instance name
 * identifiers. If the attribute is not linked to any target, the set will be
 * empty.
 * 
...
public class MultiTargetRelationalValue extends OOMDPValue implements Value {
    ...
    /**
     * The set of object targets to which this value points. Object targets are
     * indicated by their object name identifier.
     */
     ...
     * 
     * @param attribute
     *            the attribute with which this value is associated
     */
