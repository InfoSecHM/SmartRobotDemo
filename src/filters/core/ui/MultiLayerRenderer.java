...
/**
 * A MultiLayerRenderer is a canvas that will sequentially render a set of
 * render layers, one on top of the other, to the same 2D graphics context.
 * Rendering is performed offscreen to a buffered image before being displayed
 * on the screen.
 * 
...
public class MultiLayerRenderer extends Canvas {
    ...
    /**
     * Adds the specified {@link RenderLayer} to the end of the render layer
     * ordered list.
     * 
     * @param l
     *            the {@link RenderLayer} to add
     */
     ...
     * 
     * @param i
     *            the position in which the render layer should be inserted
     * @param l
     *            the render layer to insert
     */
    ...
    protected void initializeOffscreen() {
        if (this.bufferedGraphics == null || (this.lastRenderWidth != this.getWidth())
