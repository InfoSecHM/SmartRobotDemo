...
/**
 * And interface for defining painters that can render object instances to a
 * graphics context.
 * 
...
public interface ObjectPainter {
     ...
     * 
     * @param g2
     *            graphics context to which the object should be painted
     * @param s
     *            the state of the object to be painted
     * @param ob
     *            the instantiated object to be painted
     * @param cWidth
     *            width of the canvas size
     * @param cHeight
